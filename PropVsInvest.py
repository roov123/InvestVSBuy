...
st.sidebar.markdown("""<div style='border: 2px solid #007BFF; background-color:#007BFF; color:white; padding:10px; border-radius:5px; font-weight:bold; text-align:left;'>Upfront Costs</div>""", unsafe_allow_html=True)
